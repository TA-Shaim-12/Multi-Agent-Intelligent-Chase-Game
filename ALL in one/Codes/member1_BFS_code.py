# =============================================================
# AI CHASE GAME  -  MEMBER 1  CODE FILE
# Algorithm : BFS (Breadth-First Search)
# Branch    : bfs_[your_student_ID]
# File name : member1_BFS_code.py
#
# WHAT YOU DO IN THIS FILE:
#   1. Add comments to every line of bfs_path()
#   2. Add reset() and best_algo() methods to AlgorithmAnalyzer
#   3. Add "Ruined City" map to generate_map() and MAPS list
#   4. Create README_member1.md (200-word analysis)
#
