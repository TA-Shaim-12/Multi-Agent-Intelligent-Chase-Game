# =============================================================
# AI CHASE GAME  -  MEMBER 4  CODE FILE
# Algorithm : Simulated Annealing
# Sections  : Analysis Screens + HUD + Map Editor + Menu + Game Over
# Branch    : sa_[your_student_ID]
# File name : member4_SA_UI_code.py
#
# WHAT YOU DO IN THIS FILE:
#   1. Add comments to every line of sa_path()
#   2. Add algorithm tooltip to draw_menu()
#      (show description when hovering over algorithm button)
#   3. Add mini-scoreboard to draw_hud()
#      (show which player is leading during game)
#   4. Add MVP Officer line to draw_game_over()
#      (show which officer caught the most thieves)
#   5. Add save_map() and load_map() to MapEditor class
#      (save custom map to JSON file, load it back)
#   6. Create README_member4.md (200-word analysis)
#
